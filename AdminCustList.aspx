<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminCustList.aspx.cs" Inherits="AdminCustList" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Maroon" Font-Bold="False"
            ...
            left: 185px; position: absolute; top: 202px" Width="838px">Registered Customer List</asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT [uName], [cName], [cAdd], [eMail], [Mobile] FROM [CustomerTab] ORDER BY [cName]">
        </asp:SqlDataSource>
