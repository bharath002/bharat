<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminCarModel.aspx.cs" Inherits="AdminCarModel" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 103; left: 188px; position: absolute; top: 195px" BackColor="Maroon" Font-Size="XX-Large" ForeColor="#FF80FF" Width="636px">Car Model Details</asp:HyperLink>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 104; left: 186px; position: absolute; top: 284px" Text="Model Name" BackColor="#FFE0C0" BorderColor="#400000" BorderStyle="Solid" BorderWidth="1px" Font-Size="X-Large" Width="218px"></asp:Label>
        &nbsp;&nbsp;
