...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:Image ID="Image3" runat="server" Height="485px" ImageUrl="~/Images/aaa4.jpg"
            Style="z-index: 114; left: 664px; position: absolute; top: 173px" Width="634px" />
        <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="False" Font-Names="Arial Black"
            ForeColor="#C04000" NavigateUrl="~/Default.aspx" Style="z-index: 102; left: 0px;
        ...
        <asp:Image ID="Image2" runat="server" ImageAlign="Left" ImageUrl="~/images/LogoBtm.gif"
            Style="z-index: 103; left: 0px; position: absolute; top: 800px" />
        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 104; left: 36px; position: absolute; top: 219px" BackColor="Maroon" Font-Size="XX-Large" ForeColor="#FF80FF" Width="335px">Customer Login</asp:HyperLink>
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 107; left: 108px; position: absolute; top: 480px" Text="If you are not signed up with us then Register Now."></asp:Label>
        &nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 108; left: 110px; position: absolute; top: 524px" NavigateUrl="~/CustomerSignUp.aspx" BackColor="Maroon" Font-Size="X-Large" ForeColor="#FFE0C0" Width="329px">New Customer Signup</asp:HyperLink>
        <asp:TextBox ID="TextBox1" runat="server" Style="z-index: 109; left: 216px; position: absolute;
            top: 290px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1"
            ErrorMessage="* Enter the Login Name" Font-Bold="True" Font-Names="Verdana" Style="z-index: 110;
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2"
            ...
            Style="z-index: 111; left: 396px; position: absolute; top: 347px" Width="258px"></asp:RequiredFieldValidator>
        <asp:TextBox ID="TextBox2" runat="server" Style="z-index: 112; left: 218px; position: absolute;
