<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminBookingList.aspx.cs" Inherits="AdminBookingList" %>
...
<body bgcolor="#ccccff">
  ...
  ForeColor="Black" GridLines="None" Style="z-index: 105;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT [bNo], [bDate], [CabNo], [cName], [Nodays], [fromDate] FROM [CabBookingTab]  ORDER BY [bNo] DESC">
        </asp:SqlDataSource>
