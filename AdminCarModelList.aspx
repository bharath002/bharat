<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminCarModelList.aspx.cs" Inherits="AdminCarModelList" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Maroon" Font-Bold="False"
            ...
            left: 185px; position: absolute; top: 202px" Width="838px">Car Model List</asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT [ModelName], [Details] FROM [CarModelTab] ORDER BY [ModelName]">
        </asp:SqlDataSource>
