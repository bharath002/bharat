<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustBillList.aspx.cs" Inherits="CustBillList" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT [billNo], [billDate], [uName], [CabNo], [Qty], [Price], [totAmt] FROM [CabBillingTab] WHERE ([uName] = @uName) ORDER BY [billNo] DESC">
