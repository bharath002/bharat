<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustBookingList.aspx.cs" Inherits="CustBookingList" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Maroon" Font-Bold="False"
            ...
            left: 185px; position: absolute; top: 202px" Width="838px">Cab Booking List</asp:HyperLink>
  ...
  ForeColor="Black" GridLines="None" Style="z-index: 105;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT [bNo], [bDate], [CabNo], [Nodays], [fromDate] FROM [CabBookingTab] WHERE ([uName] = @uName) ORDER BY [bNo] DESC">
            <SelectParameters>
                <asp:SessionParameter Name="uName" SessionField="u1Var" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
