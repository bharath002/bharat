<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustVehicleList.aspx.cs" Inherits="CustVehicleList" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT [CabNo], [ModelName], [Details], [totSeats], [Price] FROM [CabDetailsTab] ORDER BY [ModelName]">
        </asp:SqlDataSource>
