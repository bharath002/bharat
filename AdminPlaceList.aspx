<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminPlaceList.aspx.cs" Inherits="AdminPlaceList" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Maroon" Font-Bold="False"
            ...
            left: 185px; position: absolute; top: 202px" Width="838px">Place List</asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT [PlaceName], [pDetails] FROM [PlaceNameTab] ORDER BY [PlaceName]">
        </asp:SqlDataSource>
