<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminDriverList.aspx.cs" Inherits="AdminDriverList" %>
...
<body bgcolor="#ccccff">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Maroon" Font-Bold="False"
            ...
            left: 185px; position: absolute; top: 202px" Width="838px">Driver  List</asp:HyperLink>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2"
            DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="None" Style="z-index: 105;
            left: 186px; position: absolute; top: 271px" Width="833px" Height="425px" DataKeyNames="empcode">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="SELECT [empcode], [empName], [eAdd], [MobileNo] FROM [empTab] ORDER BY [empcode]">
        </asp:SqlDataSource>
